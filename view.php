                        ...
                        <form action="update.php" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" value="<?=$task['title'];?>" name="title" readonly>
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="description" class="form-label">First Name</label>
                                    <input type="text" class="form-control" id="description" value="<?=$task['description'];?>" name="description" readonly>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" value="<?=$task['dueDate'];?>" id="dueDate" name="dueDate" readonly>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <a class="btn btn-primary" style="float: left;" href="index.php">Go Back</a>
                                </div>
